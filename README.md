...
🔸[Rick and Morty Explorer](https://github.com/diegorosadev/rick-morty-react-app) Aplicação React com TypeScript + Material UI para explorar personagens da série Rick and Morty via API pública.
